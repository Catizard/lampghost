...
export namespace dto {
	...
	export class DiffTableDataDto {
	    ...
	    GhostBestRecordTimestamp: number;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.GhostBestRecordTimestamp = source["GhostBestRecordTimestamp"];
	    }
	}
...
export namespace entity {
	...
	export class CustomCourse {
	    ...
	    static createFrom(source: any = {}) {
	        return new CustomCourse(source);
	    }
	...
	export class SongDirectory {
	    ...
	    static createFrom(source: any = {}) {
	        return new SongDirectory(source);
	    }
